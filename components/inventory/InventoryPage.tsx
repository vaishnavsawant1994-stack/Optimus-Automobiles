...
function InventoryFilter({ result, basePath, lockedFilter, onClose, interactive }: { result: InventoryResult; basePath: string; lockedFilter?: InventoryPageProps['lockedFilter']; onClose?: () => void; interactive: boolean }) {
  ...
  return (
    <aside className="inventory-filter" aria-label="Inventory filters" inert={!interactive}>
  ...
  return (
    <main className="interior-page" id="main-content">
      ...
      <section className="inventory-workspace container-wide">
        <div className="inventory-filter-desktop"><InventoryFilter result={result} basePath={basePath} lockedFilter={lockedFilter} interactive={hydrated} /></div>
